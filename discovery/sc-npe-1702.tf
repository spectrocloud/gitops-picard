module "sc-npe-1702" {
  ...
  cluster_name           = "sc-npe-1702"
  cluster_workers_per_az = 1
  cluster_network        = "10.10.242"

  # IP address (reserve 43-44 for 5-node CP)
  cluster_api_start_ip    = "52"
  cluster_api_end_ip      = "56"
  cluster_worker_start_ip = "59"
  cluster_worker_end_ip   = "64"

  netscaler_vip_api      = "10.10.182.6"
  netscaler_vip_nodeport = "10.10.182.7"
  netscaler_vip_ingress  = "10.10.182.7"
